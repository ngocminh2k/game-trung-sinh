...
export const EN: Dict = {
  ...
  ui: {
    ...
    ngPlus: { badge: 'Reincarnation +{{level}}' },
    offline: { gained: 'You meditated through {{hours}} hours away, gaining {{progress}} cultivation progress.' },
    achievements: { pastLife: 'Earned in a past life' },
  },
